    ...
    <nav className="fixed top-0 left-0 right-0 z-50 bg-black/80 backdrop-blur-lg border-b border-zinc-800">
      <div className="max-w-7xl mx-auto px-6 py-4">
        <div className="flex items-center justify-between gap-6">
          ...
          <a
            href={WHATSAPP_LINK}
            className="bg-gradient-to-r from-amber-400 to-amber-600 text-slate-950 uppercase px-6 py-2.5 rounded-lg font-semibold hover:shadow-lg hover:shadow-black/50 transition-all duration-300 transform hover:scale-105"
          >
            Probar en WhatsApp
          </a>
        </div>
